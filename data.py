...
sounds = {
    ...
    "barmaid_bandage": sound("barmaid_bandage.mp3"),
    "barmaid_rally": sound("barmaid_rally.mp3"),
    "barmaid_fireshot": sound("barmaid_fireshot.mp3"),
    "barmaid_miracle": sound("barmaid_miracle.mp3"),
    "barmaid_anthem": sound("barmaid_anthem.mp3"),
    "robot_attack": sound("robot_attack.mp3"),
    "robot_special": sound("robot_special.mp3"),
